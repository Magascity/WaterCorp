<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master"  AutoEventWireup="true" CodeBehind="ActiveCustomersList.aspx.cs" Inherits="WaterCorp.Reports.ActiveCustomersList" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-lg-12">
      ...
      ,C.[CustReference]
      ,C.[Active]      
  FROM [_tblCustomers3] C where  C.Active = 1 and  C.Verified = 1 order by C.RecordID Desc"></asp:SqlDataSource>
