...
{
    public partial class AssignComplaints : System.Web.UI.Page
    {
        ...
        private void FillStaff()
        {
            ...
            ddlResponsible.Items.Insert(0, new ListItem("--Select Staff--", "0"));


            // Define the Select statement.
            // Three pieces of information are needed: the unique id,
            // and the first and last name.
            string selectSQL = "SELECT [Email] FROM [AspNetUsers]";
            ...
            try
            {
                ...
                {
                    ListItem newItem = new ListItem();
                    newItem.Text = reader["Email"].ToString();
                    newItem.Value = reader["Email"].ToString();
                    ddlResponsible.Items.Add(newItem);
                }
                reader.Close();
            }
            catch (Exception err)
        ...
        {
            ddlDept.Items.Clear();
            ddlDept.Items.Insert(0, new ListItem("--Select Dept--", "0"));


            // Define the Select statement.
            // Three pieces of information are needed: the unique id,
            // and the first and last name.
            string selectSQL = "SELECT [DeptID]  ,[Department] FROM [tblDept]";
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    newItem.Value = reader["DeptID"].ToString();
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            string insertSQL = "spAssignComplaints";
            ...
            cmd.Parameters.AddWithValue("@AssignDepartment", ddlDept.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@AssignedTo", ddlResponsible.SelectedItem.Value);
            
            cmd.Parameters.AddWithValue("@AssignedBy", User.Identity.Name);
