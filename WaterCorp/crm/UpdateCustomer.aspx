<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdateCustomer.aspx.cs" Inherits="WaterCorp.crm.UpdateCustomer" %>
      ...
      <div class="row">
          <div class="col-md-6">
              ...
              <div class="row">
                ...
                <div class="row">
    <asp:Label runat="server" AssociatedControlID="chkStatus" CssClass="col-md-4 col-form-label">Customer Status</asp:Label>
    <div class="col-md-8">
        <asp:CheckBox ID="chkStatus" runat="server" CssClass="form-control" />
       
        <%--<asp:RequiredFieldValidator runat="server" ControlToValidate="chkStatus"
      ...
      CssClass="text-danger" ErrorMessage="The email field is required." />--%>
          ...
          <div class="row">
              ...
              <div class="col-md-8">
               ...
               <div class="row">
     <asp:Label runat="server" AssociatedControlID="txtExistingConsumption" CssClass="col-md-4 col-form-label">Consumption</asp:Label>
     <div class="col-md-8">
         <asp:TextBox runat="server" ID="txtExistingConsumption" CssClass="form-control" ReadOnly="true" />
         <asp:RequiredFieldValidator runat="server" ControlToValidate="txtExistingConsumption"
             CssClass="text-danger" ErrorMessage="The Consumption field is required." />
     </div>
 </div>

                            <div class="row">
    <asp:Label runat="server" AssociatedControlID="txtExistingTarrif" CssClass="col-md-4 col-form-label">Tarrif</asp:Label>
    <div class="col-md-8">
        <asp:TextBox runat="server" ID="txtExistingTarrif" CssClass="form-control" ReadOnly="true" />
        <asp:RequiredFieldValidator runat="server" ControlToValidate="txtExistingTarrif"
            CssClass="text-danger" ErrorMessage="The Tarrif field is required." />
    </div>
</div>

          <div class="row">
              <asp:Label runat="server" AssociatedControlID="txtExistingMeterCharges" CssClass="col-md-4 col-form-label">Existing Meter Charges</asp:Label>
              <div class="col-md-8">
                  <asp:TextBox runat="server" ID="txtExistingMeterCharges" CssClass="form-control" ReadOnly="true" />
                  <%--<asp:RequiredFieldValidator runat="server" ControlToValidate="txtMeterNo"
           CssClass="text-danger" ErrorMessage="The Meterno field is required." />--%>
                  <p></p>
              </div>
          ...
          <div class="row">
              <asp:Label runat="server" AssociatedControlID="txtReason" CssClass="col-md-4 col-form-label">Reason for Updates</asp:Label>
              <div class="col-md-8">
          ...
          <div class="row">
              <asp:Label runat="server" AssociatedControlID="fupUploadFile" CssClass="col-md-4 col-form-label">File</asp:Label>
              <div class="col-md-8">
                  <asp:FileUpload ID="fupUploadFile" runat="server" CssClass="form-control" />

                  <asp:RequiredFieldValidator runat="server" ControlToValidate="fupUploadFile"
