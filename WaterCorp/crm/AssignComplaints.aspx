<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AssignComplaints.aspx.cs" Inherits="WaterCorp.crm.AssignComplaints" %>
...
<%--    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>--%>
            <main aria-labelledby="title">
                ...
                <h4>Assign Customer Complaints</h4>
                <hr />
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <asp:Label runat="server" AssociatedControlID="ddlDept" CssClass="col-md-4 col-form-label">Assign to Dept</asp:Label>
                        <div class="col-md-8">
                            <asp:DropDownList ID="ddlDept" CssClass="form-control" runat="server"></asp:DropDownList>
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="ddlDept" InitialValue="0"
                                CssClass="text-danger" ErrorMessage="The dept field is required." />
                        </div>
                    </div>

                    <div class="row">
                        <asp:Label runat="server" AssociatedControlID="ddlResponsible" CssClass="col-md-4 col-form-label">Assign to </asp:Label>
                        <div class="col-md-8">
                            <asp:DropDownList ID="ddlResponsible" CssClass="form-control" runat="server"></asp:DropDownList>
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="ddlResponsible" InitialValue="0"
                                CssClass="text-danger" ErrorMessage="The Staff Responsible field is required." />
                        </div>
                    </div>
