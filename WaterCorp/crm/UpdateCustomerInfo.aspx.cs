...
namespace WaterCorp.crm
{
    public partial class UpdateCustomerInfo : System.Web.UI.Page
    {
        ...
        private void LoadCustomers(Int64 RecordID)
        {
            ...
            selectSQL = "SELECT [RecordID] , customername ,[Email],[PhoneNumber],[CustomerAddress],[DistrictCode], [ZoneCode],[Subzone],[Round] ,[Foliono],[Metered],[MeterNo],[MeterCharge],[FlateRateCategory],[Tarrif],[Consumption],[CustReference],Active FROM [_tblCustomers3]";
            ...
            try
            {
              ...
              //  txtFirstname.Text = reader["Firstname"].ToString();
                ...
                txtExistingMeterCharges.Text = reader["MeterCharge"].ToString();
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    cmd.Parameters.AddWithValue("@ActiveStatus", "In-Active");
