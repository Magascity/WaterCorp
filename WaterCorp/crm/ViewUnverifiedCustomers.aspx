<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewUnverifiedCustomers.aspx.cs" Inherits="WaterCorp.crm.ViewUnverifiedCustomers" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    ,[Latitude]
    ,[Longitude]
FROM [_tblCustomers3] C Where C.Verified = 0 order by C.RecordID Desc"></asp:SqlDataSource>
