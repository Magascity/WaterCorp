<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LogComplaint.aspx.cs" Inherits="WaterCorp.crm.LogComplaint" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-md-10">
        <asp:DropDownList ID="ddlService" CssClass="form-control" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlService_SelectedIndexChanged" ></asp:DropDownList>        
