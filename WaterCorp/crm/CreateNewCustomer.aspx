<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreateNewCustomer.aspx.cs" Inherits="WaterCorp.crm.CreateNewCustomer" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <main aria-labelledby="title">
        ...
        <asp:HiddenField ID="HFCBAccount" runat="server" />
        <asp:HiddenField ID="HFJVAccount" runat="server" />
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="row">
                    <asp:Label runat="server" AssociatedControlID="ddlDistrictCode" CssClass="col-md-4 col-form-label">SBU</asp:Label>
                    <div class="col-md-8">
    ...
    <div class="col-md-8">
        <asp:CheckBox ID="chkSMS" runat="server" Text=" SMS" CssClass="form-check-input" />
        <br />
    ...
    <div class="col-md-8">
       ...
       <asp:CheckBox ID="chkEmail" runat="server" Text=" Email" CssClass="form-check-input" />
